...
fmbuild: fmbuild.cpp ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a libfmindex.a
	$(CXX) -I $(INCCDS) -I $(INCDIVSUF) $(CFLAGS) -o fmbuild fmbuild.cpp libfmindex.a ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a 

fmcount: fmcount.cpp ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a libfmindex.a
	$(CXX) -I $(INCCDS) -I $(INCDIVSUF) $(CFLAGS) -o fmcount fmcount.cpp libfmindex.a ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a 
	
fmlocate: fmlocate.cpp ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a libfmindex.a
	$(CXX) -I $(INCCDS) -I $(INCDIVSUF) $(CFLAGS) -o fmlocate fmlocate.cpp libfmindex.a ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a

fmextract: fmextract.cpp ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a libfmindex.a
	$(CXX) -I $(INCCDS) -I $(INCDIVSUF) $(CFLAGS) -o fmextract fmextract.cpp libfmindex.a ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a

fmrecover: fmrecover.cpp ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a libfmindex.a
	$(CXX) -I $(INCCDS) -I $(INCDIVSUF) $(CFLAGS) -o fmrecover fmrecover.cpp libfmindex.a ./libdivsufsort/lib/libdivsufsort.a ./libcds/lib/libcds.a
